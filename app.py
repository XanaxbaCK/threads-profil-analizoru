...
if "user_db" not in st.session_state:
    st.session_state.user_db = {"murat": "snr", "demo": "demo", "alkan": "alkan", "büşra": "büşra", "azat": "azat","ali": "aksoy","sugra":"poyraz",}

if "premium_users" not in st.session_state:
    st.session_state.premium_users = {"murat", "alkan", "büşra", "azat", "ali","sugra",}
